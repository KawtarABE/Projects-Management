...
public class compose_reply_prof extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public compose_reply_prof() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/prof/compose_reply_prof.jsp").forward( request, response );
	}
