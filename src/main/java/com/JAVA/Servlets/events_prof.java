...
public class events_prof extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Event> events = obj.getAllevents_prof(id_user);
		request.setAttribute("events", events);
		request.getRequestDispatcher("/WEB-INF/prof/Events_prof.jsp").forward( request, response );
	}
