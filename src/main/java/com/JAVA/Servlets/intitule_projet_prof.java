...
public class intitule_projet_prof extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public intitule_projet_prof() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/prof/validation_projet_prof.jsp").forward( request, response );
	}
