...
<body>
<form action="allAffectations_infos" name="myform" method="post">
<div class="wrapper" style="margin-left: 470px; margin-top: 80px;">
    <div class="title">
      New Affectation
      <p id="erreur" style="display: none; margin-top: 20px; font-size: 15px; color: #B80F0A">Please choose a promotion first</p>
    </div>
    <div class="form">
      <div class="inputfield">
      	  <label>Promotion</label>
          <input style="margin-left: 14px; border-right: 0px;" type="text" name="promo" class="input" placeholder="Enter a promotion" required>
          <button type="submit" style="cursor: pointer; padding: 7px 8px; background:#B80F0A; border: none;" ><i style="font-size: 20px; color: white; " class='bx bx-search-alt-2'></i></button>
       </div>
       <div class="inputfield">
