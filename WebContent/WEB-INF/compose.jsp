...
<body>
<form action="send_message" enctype="multipart/form-data" name="myform" method="post">
<div class="wrapper" style="margin-left: 470px; margin-top: 80px;">
    ...
    <div class="form">
       <div class="inputfield">
          ...
          <div class="custom_select">
            <select name="receiver" required>
              ...
              <c:forEach items="${ encadrants }" var="encadrant" varStatus="boucle">
              	<option value="${ encadrant.getCode() }">${ encadrant.getNom() } (Encadrant)</option>
              </c:forEach>
              <c:forEach items="${ binomes }" var="binome" varStatus="boucle">
              	<option value="${ binome.getCode() }">${ binome.getNom() } (Binôme)</option>
              </c:forEach>
             </select>
          </div>
       </div>  
      ...
      <div class="inputfield">
        <button style="margin-right: 20px;"class="btn"><a href="compose" style="color: #fff; text-decoration: none;">Cancel</a></button>
