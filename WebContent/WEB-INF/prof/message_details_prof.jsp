    ...
    <div class="email-text">
     ...
     <div class="top-section">
        ...
        <div class="attachment">
          <a style="text-decoration: none; color: var(--black);" href="delete_message_prof?message_id=${ message.getId() }&action=receive">
          <i style="font-size: 20px; left: 9.5px; top: 9.5px; " class='bx bxs-trash'></i>
          </a>
        </div>
        <div style="right: 45px;" class="attachment reply">
        <a style="text-decoration: none; color: var(--black);" href="compose_reply_prof?isresponse_to=${ message.getId() }&receiver=${ message.getId_sender() }">
          <i class='bx bx-reply'></i>
        </a>
        </div>
        <div style="right: 90px;" class="attachment">
        <a style="text-decoration: none; color: var(--black);" href="mail_prof">
