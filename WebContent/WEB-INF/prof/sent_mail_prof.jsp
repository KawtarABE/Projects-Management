...
<div class="wrapper">
	<div class="inbox">
		...
		<c:forEach items="${ messages }" var="message" varStatus="boucle">
		 <li>
		 <a href="sentMessage_details_prof?message_id=${ message.getId() }" style="text-decoration:none; color: black;"> 
		 <div class="all">
			  <div class="li_left">
				    <div class='thumbnail'>
			  ...
			  <div class="li_right">
				<div class="message">
				   <div class="title"><span style="font-weight: bold;" >to :</span> ${ message.getReceiver() }</div>
				      <div class="sub_title">
		      			 <c:choose>
				   ...
				   <div class="time_status" style="position: absolute; right: 100px;">
				     <div class="time">${ message.getDate_envoie() }</div>
				   </div>
				</div>
			</div>
			</a>
