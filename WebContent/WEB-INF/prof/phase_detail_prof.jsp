...
<body>
<form action="update_phase_prof"  method="post">
	<div class="wrapper" style="margin-left: 480px; margin-top: 20px;">
	    ...
	    <div style="margin-top: 40px;" class="form-style">
			    ...
			    <div class="inner-wrap">
			        <textarea name="description" placeholder="Enter details of the phase" Readonly/>${ phase.getDetail_etudiant() }</textarea>
			    </div>
			    
			    <div style="margin-bottom: 40px; margin-top: -10px;" class="inner-wrap">
			    <div style="display: flex;">
				    <c:if test="${ phase.getFile_name() != null}">	    		    		
				    <div  id="file_form"  class="attachment-bottom">
			    ...
			    <div  class="inner-wrap">
			        <input type="number"  name="progress" placeholder="Enter a percent of realisation" value="${ phase.getPourcentage() }" Readonly/>
			    </div>
			    
			    <div class="section"><span style="margin-top: -8px;">3</span>Supervisor's comment</div>
			    <div class="inner-wrap">
			        <textarea name="description_prof" placeholder="No comment yet" />${ phase.getDetail_prof() }</textarea>
			    </div>
			    </div>
			    ...
			    <div style="margin-left: 140px;" class="inputfield">
			        <a href="allphases_prof?id_affectation=${ id_affectation }&annee=${ annee }&semestre=${ semestre }" style="color: #fff; text-decoration: none;"><button style="margin-right: 20px;"class="btn">Return</a></button>
