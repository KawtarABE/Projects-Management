...
<body>
<form action="commentprojet" method="post">
	<div class="wrapper" style="margin-left: 480px; margin-top: 50px;">
	    ...
	    <div class="form-style">
			    ...
			    <div class="inner-wrap">
			        <input type="text"  name="title" placeholder="Title of project" value="${ intitule }" Readonly/>
			    </div>
			
			    <div class="section"><span style="margin-top: -8px;">2</span>Project's details</div>
			    <div class="inner-wrap">
			        <textarea name="description" placeholder="Details of project" Readonly/>${ description }</textarea>
			    </div>
			    
			    <div class="section"><span style="margin-top: -8px;">3</span>Supervisor's Comment</div>
			    <div class="inner-wrap">
			        <textarea name="description_prof" placeholder="No comment yet"/>${ prof_description }</textarea>
			    </div>
