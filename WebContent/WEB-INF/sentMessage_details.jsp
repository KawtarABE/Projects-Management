    ...
    <div class="email-text">
     ...
     <div class="top-section">
        ...
        <div class="attachment">
          <a style="text-decoration: none; color: var(--black);" href="delete_message?message_id=${ message.getId() }&action=send">
          <i style="font-size: 20px; left: 9.5px; top: 9.5px; " class='bx bxs-trash'></i>
          </a>
        </div>
        <div style="right: 45px;" class="attachment reply">
        <a style="text-decoration: none; color: var(--black);" href="sent_mail">
